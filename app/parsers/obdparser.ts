...
export class ObdParser extends Parser {
  ...
  public static ENGINE_RPM = new ObdPid('c', 'ENGINE_RPM', 0.5);
  public static VEHICLE_SPEED = new ObdPid('d', 'VEHICLE_SPEED', 1);
  public static MAF_RATE = new ObdPid('10', 'MAF_RATE', 1);
  ...
  public static FUEL_LEVEL = new ObdPid('2f', 'FUEL_LEVEL', 5);
  public static COOLANT_TEMPERATURE = new ObdPid('5', 'COOLANT_TEMPERATURE', 5);
  public static ENGINE_LOAD = new ObdPid('4', 'ENGINE_LOAD', 2);
  public static TIMING_ADVANCE = new ObdPid('e', 'TIMING_ADVANCE', 2);
